...
/**
 * 微信配置类，将配置文件的内容引入到项目当中
 */
@Configuration//将该类交给Spring容器来管理
@PropertySource(value = "classpath:application.properties")//该配置类读取哪个位置的配置文件
//classpath表示从类路径开始，也就是从resources为根开始的
